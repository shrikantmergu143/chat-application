...
export default function InviteFriendModal() {
  ...
  return (
    <Modal className='modal fade show' prefix='modal ' dialogClassName='modal-dialog modal-dialog-centered modal-fullscreen-xl-down' containerClassName='modal-content' >
