...
export default function InviteFriendModal() {
  ...
  return (
    <Modal open={true} className='modal fade show' prefix='modal ' dialogClassName='modal-dialog modal-dialog-centered modal-fullscreen-xl-down' containerClassName='modal-content' >
    ...
    // <div class="modal fade show" id="modal-invite" tabindex="-1" aria-labelledby="modal-invite" aria-modal="true" role="dialog" >
