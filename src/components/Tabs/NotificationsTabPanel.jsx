                        ...
                        <div className="card border-0 mb-5">
                            ...
                            <div className="card-footer">
                                <div className="row gx-4">
                                    <div className="col">
                                        <Link href="#" className="btn btn-sm btn-soft-primary w-100">Hide</Link>
                                    </div>
                                    <div className="col">
                                        <Link href="#" className="btn btn-sm btn-primary w-100">Confirm</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="card-list mt-8">
                            ...
                            <div className="card-body">
                                ...
                                <div className="row gx-5">
                                    ...
                                    <div className="col">
                                        <div className="d-flex align-items-center mb-2">
                                            <h5 className="me-auto mb-0">
                                                <Link href="#">Don Knight</Link>
                                            </h5>
                                            <span className="extra-small text-muted ms-2">08:45 PM</span>
                                        </div>

                                        <div className="d-flex">
                                            {/* <!-- <div className="me-auto">Removed you from the chat <Link href="#" className="text-reset">Bootstrap Community</Link>.</div> --> */}
                        ...
                        <div className="card border-0">
                            <div className="card-body">
                                ...
                                <div className="row gx-5">
                                    <div className="col-auto">
                                        <Link href="#tab-settings" className="avatar avatar-badged" data-theme-toggle="tab">
                                            ...
                                            <div className="badge badge-circle bg-danger border-outline position-absolute bottom-0 end-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-power"><path d="M18.36 6.64a9 9 0 1 1-12.73 0"></path><line x1="12" y1="2" x2="12" y2="12"></line></svg>
                                            </div>
                                        </Link>
                                    </div>
                                    ...
                                    <div className="col">
                                        <div className="d-flex align-items-center mb-2">
                                            <h5 className="me-auto mb-0">
                                                <Link href="#tab-settings" data-theme-toggle="tab">
                                                    Notifications
                                                </Link>
                                            </h5>
                                            <span className="extra-small text-muted ms-2">08:45 PM</span>
