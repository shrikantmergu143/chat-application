...
export default function TabBarComponent() {
    ...
    const TabListItem = ({item}) =>{
        return(
            <li className="nav-item">
                <a className={`nav-link py-0 py-lg-8 cursor-pointer ${activeTab == item?.clickData ?"active":""} `} id={item?.id} onClick={(e)=>onClickTab(e, item?.clickData)} title={item?.title} data-bs-toggle="tab" role="tab">
  ...
  return (
    <nav className="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
        {/* <!-- Brand --> */}
        <a title="Messenger" className="d-none d-xl-block mb-6">
        ...
        <ul className="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3" role="tablist">
            ...
            {/* <li className="nav-item">
                <a className="nav-link py-0 py-lg-8" id="tab-create-chat" onClick={(e)=>onClickTab(e, TabLabel?.CreateTabPanel)} title="Create chat" data-bs-toggle="tab" role="tab">
                    <div className="icon icon-xl">
            ...
            {/* <!-- Friends --> */}
            {/* <li className="nav-item">
                <a className="nav-link py-0 py-lg-8" id="tab-friends" onClick={(e)=>onClickTab(e, TabLabel?.FriendsTabPanel)} title="Friends" data-bs-toggle="tab" role="tab">
                    <div className="icon icon-xl">
